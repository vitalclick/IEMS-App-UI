...
export default function Header() {
  return (
    <header className="relative bg-teal px-5 pt-4 pb-16 rounded-b-[32px]">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="flex items-center gap-1" aria-label="Profile menu">
            <span className="h-9 w-9 overflow-hidden rounded-full ring-2 ring-white/40 bg-gradient-to-br from-orange-light to-orange flex items-center justify-center text-xs font-bold text-white">
              NO
            </span>
